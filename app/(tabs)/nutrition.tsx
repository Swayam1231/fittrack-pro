...
export default function Nutrition() {
  ...
  const mealsByType = useMemo(() => {
    const map: Record<(typeof MEAL_TYPES)[number], any[]> = {
      Breakfast: [],
      Lunch: [],
      Dinner: [],
      Snacks: [],
        ...
        <View style={styles.searchSection}>
          ...
          >
            ...
            <TextInput
              ...
              style={[
                styles.searchInput,
                { color: colors.textPrimary, fontFamily: "Manrope-Medium" },
              ]}
            />
          </View>
        </View>
          ...
          {MEAL_TYPES.map((type, index) => (
            <MealGroup
              ...
              onAdd={() =>
                router.push({
                  pathname: "/add-meal",
                  params: { mealType: type, date: date.toISOString() },
                })
              }
            />
          ))}
    ...
    <View style={styles.macroItem}>
      <View style={styles.macroHeader}>
        <Text
          style={[
            styles.macroLabel,
            { color: colors.textSecondary, fontFamily: "Manrope-Bold" },
          ]}
        >
          {label.toUpperCase()}
        </Text>
  ...
  return (
    ...
    >
      ...
      <Text
        style={[
          styles.rapidLabel,
          { color: themeColors.textPrimary, fontFamily: "Manrope-Bold" },
        ]}
      >
        {label}
      </Text>
          ...
          >
            <View>
              ...
              <Text
                style={[
                  styles.mealGrams,
                  { color: colors.textSecondary, fontFamily: "Manrope-Medium" },
                ]}
              >
                {meal.grams}g • P: {meal.protein}g C: {meal.carbs}g F:{" "}
                {meal.fats}g
              </Text>
            </View>
            <Text
